...
def tela_cadastro(janela):
    ...
    botao_salvar = tk.Button(janela, text="Salvar Produto", bg="green", fg="white", 
                           command=lambda: salvar_produto(entry_nome, entry_preco))
...
def tela_menu_principal(janela, nome_loja):
            ...
            botao_cadastrar_produto = tk.Button(janela, text="Cadastrar Novo Produto", command=lambda: tela_cadastro(janela))
